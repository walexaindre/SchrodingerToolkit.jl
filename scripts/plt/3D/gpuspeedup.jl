...
lines!(Ax2D,x[1:length(speeduplu)],speeduplu,label="LU",color = :blue, linestyle = :dash, linewidth = 3.5)
lines!(Ax2D,x[1:length(speedupgmres)],speedupgmres,label="GMRES",color = :red, linestyle = :dash, linewidth = 3.5)
