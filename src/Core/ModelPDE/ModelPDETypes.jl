...
- `T::Tv`: Final time
"""
struct SchrodingerPDENonPolynomial{N,Tv,MComp,Potential} <: SchrodingerPDE{N,Tv}
...
- `T::Tv`: Final time
"""
struct SchrodingerPDEPolynomial{N,Tv,MComp,Potential,Optimized} <: SchrodingerPDE{N,Tv}
    boundaries::NTuple{N,NTuple{2,Tv}}
    components::MComp
    F::Potential
    N::Optimized
...
export SchrodingerPDE, SchrodingerPDEComponent, SchrodingerPDEPolynomial, SchrodingerPDENonPolynomial